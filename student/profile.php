...
$studCamp =$_SESSION['campus'];
  ...
  if (isset($_POST['btnUpdate']))
  {
          ...
          {
            $_SESSION['message'] = "Password field are empty";
          ...
          if (!empty($password)&&!empty($cPassword))
          {
              if ($password == $cPassword)
              {
                      ...
                      $sql = "UPDATE student SET studPassword = '$newPwd' WHERE 	studID = '$studId';";
                      mysqli_query($conn,$sql);

                      $_SESSION['message'] = "Student profile Successfully updated";
...
{
  $sql = "SELECT* FROM student WHERE studEmail = '$studEmail';";
             ...
             <?php
                   ...
                   <form action="profile.php" method="post">
                           ...
                           <div class="form-group">
                              ...
                              value="<?php echo $row['studSurname']; ?>"
                           ...
                           <div class="col-md-12 text-center ">
                              <button name="btnUpdate" onclick="email()" type="submit" style="border-radius: 50px;" class="btn btn-info">Update Password</button>
                           </div>
