        ...
        <div class="container-fluid" >
              ...
              <div class="collapse navbar-collapse " id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                          <a href="viewbookings.php" class="nav-link">View Booking</a>
                        </li>
...
<div id="slides" class="carousel slide" data-ride = "carousel" >
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item ">
                <img src="image_covid19/4.jpg" style="border-radius: 50px;" alt="">
          </div>
          <div class="carousel-item">
                <img src="image_covid19/5.jpg" style="border-radius: 50px;"alt="">
          </div>
          <div class="carousel-item">
...
<hr>
<footer style="background-color: #9C5EFF;text-color:white;">
      <div class="container-fluid padding">
              <div class="row text-center">
                      ...
                      <div class="col-md-4">
                          <a href="#"><img src="image/logTUT.png" alt=""></a>
